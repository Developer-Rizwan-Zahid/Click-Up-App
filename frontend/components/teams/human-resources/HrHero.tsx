        ...
        <section className="bg-white pt-32 pb-24 overflow-hidden relative">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="flex flex-col items-center text-center max-w-4xl mx-auto mb-16">
                    ...
                    >
                        <span className="px-3 py-1 bg-green-100 text-green-600 rounded-full text-xs font-bold tracking-widest uppercase">
                            HR Management
                        </span>
                    </motion.div>
                ...
                >
                    ...
                    <div className="bg-red-50/50 border border-red-100 rounded-2xl p-8 transform hover:-translate-y-1 transition-transform duration-300">
                        ...
                        <ul className="space-y-4">
                            {[
                                "Disorganized spreadsheets for candidate tracking",
                                "Onboarding feels disconnected and manual",
                                "Employee data scattered across folders",
                                "Slow communication slows down hiring"
                            ].map((item, i) => (
                    ...
                    {/* The ClickUp Way */}
                    <div className="bg-green-50/50 border border-green-100 rounded-2xl p-8 relative overflow-hidden transform hover:-translate-y-1 transition-transform duration-300 shadow-lg">
                        ...
                        <ul className="space-y-4 relative">
                            {[
                                "Centralized pipeline for all candidates",
                                "Automated onboarding checklists & tasks",
                                "Secure, organized employee profiles",
                                "Real-time feedback & collaboration on hires"
                            ].map((item, i) => (
                                <li key={i} className="flex items-start gap-3 text-gray-600">
            ...
            <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none -z-10">
                <div className="absolute top-[-10%] left-[-10%] w-[50%] h-[50%] bg-green-50/50 rounded-full blur-[120px]" />
