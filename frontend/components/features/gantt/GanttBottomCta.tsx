...
export default function GanttBottomCta() {
    return (
        <section className="py-20 bg-white">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                <div className="bg-black rounded-[2.5rem] overflow-hidden relative py-20 px-6 md:px-20 text-center shadow-2xl">
                    {/* Background Glows */}
                    ...
                    <div className="relative z-10 max-w-4xl mx-auto">
                        ...
                        >
                            <h2 className="text-4xl md:text-5xl lg:text-6xl font-black text-white mb-6 leading-tight tracking-tight">
                                Plan your work, with Gantt Charts.
                            </h2>
