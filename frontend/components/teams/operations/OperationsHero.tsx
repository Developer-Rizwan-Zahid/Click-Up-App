        ...
        <section className="bg-white pt-32 pb-24 overflow-hidden relative">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="flex flex-col items-center text-center max-w-4xl mx-auto mb-16">
                    ...
                    >
                        <span className="px-3 py-1 bg-blue-100 text-blue-600 rounded-full text-xs font-bold tracking-widest uppercase">
                            Operations
                        </span>
                    </motion.div>
                    ...
                    >
                        Disconnected tools and processes slow operations and increase risk. ClickUp unites every team workflow, project, and collaboration—so everything runs smoothly 24/7.
                    </motion.p>
                ...
                >
                    ...
                    {/* The ClickUp Way */}
                    <div className="bg-blue-50/50 border border-blue-100 rounded-2xl p-8 relative overflow-hidden transform hover:-translate-y-1 transition-transform duration-300 shadow-lg">
