        ...
        <div className="w-full bg-white pt-28 pb-8 px-4 md:px-8 lg:px-16 flex flex-col relative">
            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-4 mb-4">
                ...
                <div className="flex items-center gap-2 text-sm text-slate-500">
                    ...
                    <span className="text-slate-300">›</span>
                    <span className="font-medium text-slate-900 bg-slate-100 px-2 py-0.5 rounded">Marketing</span>
                </div>
            ...
            <div className="mb-10">
                ...
                <p className="text-base text-slate-600 max-w-3xl leading-relaxed">
                    Develop and optimize every facet of your brand with ClickUp's Marketing templates. Campaigns, budgets, and creative—all in one place.
                </p>
            </div>
